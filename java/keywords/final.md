...
- A final static field is a class field that can’t be reassigned , or given a different value , after the class’s intialization process. A field decleard on an interface is always public static and final.
